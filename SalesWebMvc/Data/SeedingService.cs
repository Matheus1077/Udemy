...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public object SalesStatus { get; private set; }
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Matheus", "matheus@gmail.com", new DateTime(1998, 2, 27), 1000.0, d1);
            Seller s2 = new Seller(2, "Michele", "michele@gmail.com", new DateTime(1993, 11, 30), 1500.0, d2);
            Seller s3 = new Seller(3, "Kelly Campos", "keloca@yahoo.com", new DateTime(1978, 1, 25), 1700.0, d3);
            Seller s4 = new Seller(4, "Washington", "wluiz@gmail.com", new DateTime(1970, 11, 24), 1559.0, d4);
            Seller s5 = new Seller(5, "Davi", "davi@hotmail.com", new DateTime(2013, 2, 15), 2000.0, d2);
            Seller s6 = new Seller(6, "Felipe", "felipe@gmail.com", new DateTime(2002, 12, 2), 1250.0, d4);
